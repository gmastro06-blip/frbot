...
_eat_food_action = globals().get("eat_food")
if not callable(_eat_food_action):
    def _eat_food_action(*args: object, **kwargs: object) -> None:
        return None

persistent_actions = [{'interval':60, 'action':_eat_food_action}]
